...
#if using termux
plt.savefig('./circle/figs/circle_const_ccircle.pdf')
plt.savefig('./circle/figs/circle_const_ccircle.eps')
subprocess.run(shlex.split("termux-open ./circle/figs/circle_const_ccircle.pdf"))
#else
#plt.show()
