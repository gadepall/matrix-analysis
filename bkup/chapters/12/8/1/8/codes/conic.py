...
sys.path.insert(0,'/sdcard/FWC/Kedar/fwc-module1/trunk/matrix/CoordGeo')         #path to my scripts
#Circle Assignment
import numpy as np
...
k = -2*eta/lamda[1]   # y^2 = ax => y'Dy = (-2eta)e1'y
...
#def integrand1(x, a, b):
 #   return ()
A2,err=quad(integrand1, a, 4, args=(a,b))
area=A2-A1;
print(np.abs(area));
...
#plt.savefig('/sdcard/dinesh/codes/conics1.pdf)
#subprocess.run(shlex.split("termux-open '/sdcard/Download/codes/conics1.pdf' "))
