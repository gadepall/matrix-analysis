...
#plt.axis('equal')
#if using termux
plt.savefig('./line/figs/line_dist_parallel_py.pdf')
plt.savefig('./line/figs/line_dist_parallel_py.eps')
subprocess.run(shlex.split("termux-open ./line/figs/line_dist_parallel_py.pdf"))
#else
#plt.show()
