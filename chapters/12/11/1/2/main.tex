...
\begin{enumerate}[start=2]
    ...
    \solution Suppose the line cosines are given by
    \begin{align}
        \vec{x} = \myvec{\cos\alpha\\\cos\alpha\\\cos\alpha} 
    \end{align}
    As per the property of direction cosines, we have
    \begin{align}
        \norm{\vec{x}} = \sqrt{\cos^2\alpha + \cos^2\alpha + \cos^2\alpha} = 1\\
        \sqrt{3\times(\cos\alpha)^2} = 1 \\
