...
#sys.path.insert(0, '/sdcard/Download/codes/line/CoordGeo')        #path to my scripts
...
#if using termux
plt.savefig('/sdcard/Download/codes/line/p1.pdf')
subprocess.run(shlex.split("termux-open '/sdcard/Download/codes/line/p1.pdf'")) 
#else
#plt.show()
