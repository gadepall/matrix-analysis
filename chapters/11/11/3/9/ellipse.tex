...
\begin{align}
	\vec{V} = \myvec{\frac{1}{9} & 0\\0&\frac{1}{4}},\,
	f = -1,\,
	\vec{u} = \myvec{0}
\end{align}
\begin{enumerate}
...
\item From
	...
	\end{align}
\item From 
	\eqref{eq:std-nonparab-vert}, the 
	vertices of the ellipse are
\begin{align}
\pm 3 \vec{e}_1
\end{align}
\item From
	\eqref{eq:std-nonparab-major-len},
	length of the major axis is $6$.
\item From
	\eqref{eq:std-nonparab-minor-len},
	length of the major axis is $4$.
\item From 
...
\end{enumerate}
See 
    \figref{fig:chapters/11/11/3/9/}.
%
\begin{figure}[h!]
  \centering
    \includegraphics[width=\columnwidth]{chapters/11/11/3/9/figs/Figure_1.png}
    \caption{}
    \label{fig:chapters/11/11/3/9/}
\end{figure}
