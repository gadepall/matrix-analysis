...
ellipAxis_A = n
ellipAxis_B = -n
len_major = LA.norm(ellipAxis_A-ellipAxis_B)

#Points for Ellipse Minor Axis
ellipMinorAxis_A = 0.4*m 
ellipMinorAxis_B = -0.4*m
len_minor = LA.norm(ellipMinorAxis_A-ellipMinorAxis_B)
...
plt.title('Ellipse')
#if using termux
plt.savefig('/sdcard/Download/latexfiles/conics/figs/ellipse.png')
#else
print(f"focus points are {F1,F2}")
print(f"lenfth of major axis = {len_major}")
print(f"length of minor axis = {len_minor}")
plt.show()
